...
public class FXMLController {
    ...
    void initialize() {
        ...
        clV1.setCellValueFactory(new PropertyValueFactory<Adiacenza, String>("nomeZ1"));
        clV2.setCellValueFactory(new PropertyValueFactory<Adiacenza, String>("nomeZ2"));
        clPeso.setCellValueFactory(new PropertyValueFactory<Adiacenza, Integer>("peso"));
    }
    
    public void setModel(Model model) {
    	this.model = model;
    	cmbBorough.getItems().addAll(this.model.getBorghi());
    }
